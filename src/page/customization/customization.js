    ...
    function render() {
        Data.getSystemTimes().done(function(res){
            ...
            var remains_time = computeTime(res.now,0),
                title = '<!--<div class="title grid"><div class="row"><h1 class="tit-content col col-15">米酷</h1><div class="tit-search col col-8"></div></div></div>--><div class="navbar-fixed-top top-nav grid"><ul class="top-nav-ul row"><li class="top-nav-li col col-33"><div >商城</div></li><li class="top-nav-li col col-33"><div >众筹</div></li><li class="top-nav-li col col-33"><div class="active">私人定制</div></li></ul></div>',
                header = title+'<section id="subcategory" class="page-content"><div class="banner"><img src="'+imgPath+'temporary/customization/time_bg.jpg" alt=""><div class="time_day"><div class="time_img"><img src="'+imgPath+'temporary/customization/'+remains_time[0]+'.png" alt=""></div><div class="time_img"><img src="'+imgPath+'temporary/customization/'+remains_time[1]+'.png" alt=""></div></div></div><div class="activity" data-banner="421"></div></section>';
    ...
    function getBanner(){
        var banners =[
            {categoryId: 20000003,
                ...
                weight: 1},
            {categoryId: 20000102,
                description: "婴幼儿舒感健肤泡泡沐浴露",
                picUrl: imgPath+"index/8402.jpg",
                redirectType: 311,
                showText: 1,
                soldCount: 58,
                target: "8402",
                ...
                weight: 1},
            {categoryId: 20000003,
                description: "原生液润透焕颜睡眠冰膜",
                picUrl: imgPath+"index/8446.jpg",
                redirectType: 311,
                showText: 1,
                soldCount: 58,
                target: "8446",

define("plugin/easing/1.3/easing", ["jquery"], function($) {
    ...
    $.easing && $.extend($.easing, Easing);
    // 可以通过 require 获取
    return Easing;
});

define("component/switchable/1.0.3/switchable", ["jquery", "arale/widget/1.1.1/widget", "./plugins/effects", "./plugins/autoplay", "./plugins/circular", "plugin/easing/1.3/easing"], function($, Widget, Effects, Autoplay, Circular) {
    // Switchable
    // -----------
    ...
    var Switchable = Widget.extend({
        attrs: {
            ...
            activeTriggerClass: {
                getter: function(val) {
                    return val ? val : this.get("classPrefix") + "-trigger-active";
                }
            }
        },
        setup: function() {
        ...
        _initPanels: function(role) {
            ...
            if (panels.length > 0) {
                ...
                this.set("panels", panels = role.content.children());
        ...
        _bindTriggers: function() {
            ...
            } else if(this.get("triggerType") === "tap"){
                triggers.on('tap', focus);
            } else {
    ...
    var Tabs =  Switchable.extend({});

    Switchable.Accordion = Accordion;
    Switchable.Carousel = Carousel;
    Switchable.Slide = Slide;
    Switchable.Tabs = Tabs;
    return Switchable;
});

define("component/switchable/1.0.3/plugins/effects", [ "jquery", "easing" ], function($) {
    var SCROLLX = "scrollx";
    var SCROLLY = "scrolly";
    var FADE = "fade";
    // 切换效果插件
...
define("component/switchable/1.0.3/plugins/autoplay", [ "jquery" ], function($) {
    var win = $(window);
    // 自动播放插件
    var exports = {
        attrs: {

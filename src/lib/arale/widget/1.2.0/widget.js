define("arale/widget/1.2.0/widget", [
    "jquery",
    "arale/base/1.2.0/base",
    "arale/widget/1.2.0/daparser",
    "arale/widget/1.2.0/auto-render"
], function($, Base, DAParser, AutoRender) {
    // Widget
    // ---------
   ...
   /* var Base = require('arale-base')
     ...
     */
    /*Widget.parseEventName = function(widget){
        var className = widget.get('className') || 'widget';
        var tmp = [className];
